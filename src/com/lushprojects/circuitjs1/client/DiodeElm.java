...
class DiodeElm extends CircuitElm {
	...
	void setPoints() {
		super.setPoints();
		calcLeads(16);
		Point pa[] = Point.getTwoOppositelyShiftedPoints(lead1, lead1, lead2, height);
		cathode = Point.getTwoOppositelyShiftedPoints(lead2, lead1, lead2, height);
